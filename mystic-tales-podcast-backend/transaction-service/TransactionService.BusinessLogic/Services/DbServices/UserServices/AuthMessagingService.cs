...
{
    public class AuthMessagingService
    {
        // LOGGER
        private readonly ILogger<AuthMessagingService> _logger;
        ...
        public AuthMessagingService(ILogger<AuthMessagingService> logger, AppDbContext appDbContext, BcryptHelper bcryptHelper, JwtHelper jwtHelper,
