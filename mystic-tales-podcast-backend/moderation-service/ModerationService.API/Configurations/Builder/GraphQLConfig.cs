using ModerationService.API.GraphQL.Extensions;
using ModerationService.GraphQL.Schema;
using System.Reflection;
using ModerationService.API.GraphQL.Registrations;


namespace ModerationService.API.Configurations.Builder
{
