...
{
    [Route("api/query/entity")]
    [ApiController]
    [TypeFilter(typeof(HttpExceptionFilter))]
    public class ServiceEntityQueryController : ControllerBase
    {
        private ILogger<ServiceEntityQueryController> _logger;
        private readonly FileIOHelper _fileIOHelper;

        public ServiceEntityQueryController(
            ILogger<ServiceEntityQueryController> logger,
