using SurveyTalkService.Infrastructure.Services.Consul;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using SurveyTalkService.Infrastructure.Services.AWS.S3;
using SurveyTalkService.Infrastructure.Services.EmbeddingVector;
using SurveyTalkService.Infrastructure.Services.Google.Email;
using SurveyTalkService.Infrastructure.Services.OpenAI._4oMini;
using SurveyTalkService.Infrastructure.Services.Payos;
using SurveyTalkService.Infrastructure.Services.Redis;
...
using Net.payOS;
using SurveyTalkService.Infrastructure.Services.Kafka;
