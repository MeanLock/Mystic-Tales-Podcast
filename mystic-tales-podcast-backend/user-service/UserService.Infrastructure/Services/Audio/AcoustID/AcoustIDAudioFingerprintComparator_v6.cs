...
//                         // Tính toán tỷ lệ tương đồng với enhanced logic
//                         // var similarityPercentage = CalculateFingerprintSimilarityWithEarlyTermination(targetFingerprint, candidate.AudioFingerPrint);
...
//         /// <summary>
//         /// Enhanced similarity calculation với early termination logic
//         /// </summary>
//         private float CalculateFingerprintSimilarityWithEarlyTermination(string fingerprint1, string fingerprint2)
//         {
//             try
//             {
...
//                 {
//                     return CalculateChromaprintSimilarityWithEarlyTermination(chromaData1, chromaData2);
//                 }
...
//         /// <summary>
//         /// Enhanced chromaprint similarity với early termination rules
//         /// </summary>
//         private float CalculateChromaprintSimilarityWithEarlyTermination(uint[] fingerprint1, uint[] fingerprint2)
//         {
//             // Check length difference rule: nếu target dài hơn 30% thì pass
//             var lengthRatio = CalculateLengthRatio(fingerprint1, fingerprint2);
//             if (lengthRatio > 1.3f)
//             {
//                 _logger.LogDebug($"Target is {lengthRatio:F2}x longer than candidate (>30%), skipping detailed comparison");
//                 return 0f; // Pass (skip) this comparison
//             }
...
//             // Early termination check: nếu khác nhau vượt 20% thì dừng
//             if (subsequenceMatch < 80f)
//             {
//                 _logger.LogDebug($"Subsequence match {subsequenceMatch:F2}% < 80%, early termination");
//                 return subsequenceMatch;
//             }

//             // 2. Sliding window với bit tolerance
//             var slidingWindowResult = CalculateChromaprintSlidingWindow(fingerprint1, fingerprint2);
//             similarities.Add(slidingWindowResult);

//             // Early termination check after sliding window
//             if (slidingWindowResult < 80f)
//             {
//                 _logger.LogDebug($"Sliding window {slidingWindowResult:F2}% < 80%, early termination");
//                 return Math.Max(subsequenceMatch, slidingWindowResult);
//             }

//             // 3. Hamming distance với bit masking
//             var hammingResult = CalculateChromaprintHamming(fingerprint1, fingerprint2);
//             similarities.Add(hammingResult);

//             // Early termination check after hamming
//             if (hammingResult < 80f)
//             {
//                 _logger.LogDebug($"Hamming {hammingResult:F2}% < 80%, early termination");
//                 return similarities.Max();
//             }

//             // 4. Cross-correlation analysis
//             var crossCorrResult = CalculateChromaprintCrossCorrelation(fingerprint1, fingerprint2);
//             similarities.Add(crossCorrResult);
...
//         /// <summary>
//         /// Calculate length ratio between two fingerprints
//         /// </summary>
//         private float CalculateLengthRatio(uint[] fingerprint1, uint[] fingerprint2)
//         {
//             if (fingerprint2.Length == 0) return float.MaxValue;
//             return (float)fingerprint1.Length / fingerprint2.Length;
//         }

//         /// <summary>
//         /// Original similarity calculation (fallback)
//         /// </summary>
