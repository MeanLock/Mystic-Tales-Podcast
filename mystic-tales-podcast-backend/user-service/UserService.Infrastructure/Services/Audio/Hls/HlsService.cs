...
//                 if (_hlsConfig.Encryption.Enabled)
//                 {
//                     var keyPaths = await CreateEncryptionKeyAsync(hlsDir, cancellationToken);
//                     keyInfoPath = keyPaths.keyInfoPath;
//                     keyFilePath = keyPaths.keyFilePath;
//                 }
...
//         /// <summary>
//         /// Run FFmpeg command to convert audio to HLS
//         /// </summary>
...
//         //         if (!string.IsNullOrEmpty(keyInfoPath))
//         //         {
//         //             // arguments.Append($" -hls_key_info_file \"{keyInfoPath}\"");
//         //         }
...
//         //         _logger.LogDebug($"Running FFmpeg: {processStartInfo.Arguments}");
...
//                 arguments.Append($" -c:a aac -b:a 192k -ar 44100"); // Add sample rate for consistency

//                 // HLS specific settings for proper EXTINF
//                 arguments.Append($" -hls_time {segmentDuration}");
//                 arguments.Append($" -hls_list_size 0"); // Keep all segments in playlist
//                 arguments.Append($" -hls_playlist_type vod");
//                 arguments.Append($" -hls_segment_type mpegts");
//                 arguments.Append($" -hls_flags independent_segments"); // Ensure proper segment boundaries
//                 arguments.Append($" -force_key_frames \"expr:gte(t,n_forced*{segmentDuration})\""); // Force keyframes at segment boundaries
//                 arguments.Append($" -hls_segment_filename \"{segmentPattern}\"");

//                 // Add segment duration precision
...
//                 _logger.LogDebug($"Running FFmpeg: {processStartInfo.FileName} {processStartInfo.Arguments}");
...
//                     {
//                         // Validate and potentially fix the playlist
...
//             try
//             {
//                 var arguments = $"-hide_banner -nostdin -i \"{audioFilePath}\" -f null - 2>&1";
...
//                 _logger.LogDebug($"Fallback: Getting duration with FFmpeg: {arguments}");
...
//                     _logger.LogDebug($"FFmpeg combined output: {combinedOutput}");

//                     // Look for Duration line in output
//                     var lines = combinedOutput.Split('\n');
//                     foreach (var line in lines)
//                     {
//                         if (line.Contains("Duration:"))
//                         {
//                             // Format: Duration: 00:03:45.67, start: 0.000000, bitrate: 192 kb/s
...
//                                 _logger.LogInformation($"Parsed audio duration (fallback): {totalSeconds} seconds");
//                                 return totalSeconds;
//                             }
//                         }
//                     }
...
//                 _logger.LogWarning("Could not parse audio duration from FFmpeg fallback output");
//                 return 0;
//             }
//             catch (Exception ex)
//             {
//                 _logger.LogError(ex, "Error in FFmpeg fallback duration detection");
//                 return 0;
//             }
//         }
