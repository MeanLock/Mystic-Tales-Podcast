...
namespace SubscriptionService.API.Authorizations.Handlers
{
    public class AccountBasicAccessHandler : AuthorizationHandler<AccountBasicAccessRequirement>
    {
        ...
        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, AccountBasicAccessRequirement requirement)
        {
