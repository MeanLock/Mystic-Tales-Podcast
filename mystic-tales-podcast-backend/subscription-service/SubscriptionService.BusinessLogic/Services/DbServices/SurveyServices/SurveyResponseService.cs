...
using SubscriptionService.BusinessLogic.DTOs.Survey.Session;
...
using SubscriptionService.BusinessLogic.DTOs.Survey.TakenResult;
using SubscriptionService.BusinessLogic.Services.EmbeddingVectorServices;
using SubscriptionService.DataAccess.Entities.postgres;
using Pgvector;
