...
namespace SubscriptionService.BusinessLogic.Services.CrossServiceServices.QueryServices
{
    public class GenericQueryService
    {
        ...
        // Helper method để kiểm tra nullable types
        private bool IsNullableType(Type type)
        {
            return !type.IsValueType || (Nullable.GetUnderlyingType(type) != null);
        }

        // Enhanced conversion method với hỗ trợ đầy đủ GUID và null
        ...
        // Helper method để convert GUID an toàn
        ...
        // Helper method để convert DateTime an toàn
        ...
        // Enhanced expression creation method
