using BookingManagementService.API.Configurations.App;
using BookingManagementService.API.Configurations.Builder;
using BookingManagementService.BusinessLogic;
using BookingManagementService.Common;
using BookingManagementService.DataAccess;
using BookingManagementService.Infrastructure;

namespace BookingManagementService.API
{
