...
using BookingManagementService.API.GraphQL.Features.Json.Queries;
using BookingManagementService.GraphQL.Schema.QueryGroups;
using BookingManagementService.API.GraphQL.Features.Book.Queries;

namespace BookingManagementService.API.GraphQL.Registrations
{
