...
using SystemConfigurationService.BusinessLogic.Attributes;
using SystemConfigurationService.BusinessLogic.Enums.Kafka;
...
namespace SystemConfigurationService.BusinessLogic.MessageHandlers
{
        ...
        public async Task HandleForgotPasswordAsync(string key, string messageJson)
        {
            try
            {
                ...
                var notificationEvent = new EmailNotificationEvent
                {
                    ...
                    Subject = "Thông báo từ SystemConfigurationService gửi đến Architecture_1",
