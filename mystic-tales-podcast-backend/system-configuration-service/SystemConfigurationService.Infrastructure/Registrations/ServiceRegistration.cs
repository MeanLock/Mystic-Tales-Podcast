using SystemConfigurationService.Infrastructure.Services.Consul;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using SystemConfigurationService.Infrastructure.Services.AWS.S3;
using SystemConfigurationService.Infrastructure.Services.EmbeddingVector;
using SystemConfigurationService.Infrastructure.Services.Google.Email;
using SystemConfigurationService.Infrastructure.Services.OpenAI._4oMini;
using SystemConfigurationService.Infrastructure.Services.Payos;
...
using SystemConfigurationService.Infrastructure.Services.Audio.AcoustID;
