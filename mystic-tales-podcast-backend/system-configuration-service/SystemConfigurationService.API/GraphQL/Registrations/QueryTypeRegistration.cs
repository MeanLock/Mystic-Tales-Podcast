...
using SystemConfigurationService.API.GraphQL.Features.Json.Queries;
using SystemConfigurationService.GraphQL.Schema.QueryGroups;
using SystemConfigurationService.API.GraphQL.Features.Book.Queries;

namespace SystemConfigurationService.API.GraphQL.Registrations
{
