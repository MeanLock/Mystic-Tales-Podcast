...
using UserService.API.GraphQL.Features.Json.Queries;
using UserService.GraphQL.Schema.QueryGroups;
using UserService.API.GraphQL.Features.Book.Queries;

namespace UserService.API.GraphQL.Registrations
{
