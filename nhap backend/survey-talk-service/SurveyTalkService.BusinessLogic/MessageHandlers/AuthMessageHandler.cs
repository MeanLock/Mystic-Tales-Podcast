...
using SurveyTalkService.BusinessLogic.Attributes;
...
using SurveyTalkService.Infrastructure.Models.Kafka;

namespace SurveyTalkService.BusinessLogic.MessageHandlers
{
        ...
        public async Task HandleForgotPasswordAsync(string key, string messageJson)
        {
            try
            {
                ...
                var notificationEvent = new EmailNotificationEvent
                {
                    ...
                    Subject = "Thông báo từ SurveyTalkService gửi đến Architecture_1",
