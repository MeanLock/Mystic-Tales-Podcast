using Architecture_1.API.GraphQL.Extensions;
using Architecture_1.GraphQL.Schema;
using System.Reflection;
using Architecture_1.API.GraphQL.Registrations;
using Architecture_1.GraphQL.Common.Types;
using Architecture_1.GraphQL.Common.Scalars;
