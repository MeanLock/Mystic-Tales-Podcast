...
interface ShowReportViewContextProps {
...
export const ShowReportViewContext = createContext<ShowReportViewContextProps | null>(null)
...
const ShowReportView: FC<ShowReportViewProps> = () => {
    ...
    return (
        <ShowReportViewContext.Provider value={{ handleDataChange }}>
            <div className="d-flex justify-content-between align-items-center mb-4">
                <h4 className="fw-semibold" style={{ color: "var(--primary-grey)" }}>Show Reports</h4>
            </div>
            <CRow >
                <CCol xs={12}>
                    {isLoading ? (
        ...
        </ShowReportViewContext.Provider>
    )
}
