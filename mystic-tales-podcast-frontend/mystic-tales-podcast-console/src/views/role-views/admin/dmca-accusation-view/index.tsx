        ...
        cellRenderer: (params: any) => {
          ...
          return (
            <div className="d-flex gap-2 align-items-center h-100">
              <CButton
                onClick={() => navigate("/dmca-accusation/" + DMCAAccusationId + "/" + "show")}
              >
      ...
      },
      {
        ...
        cellRenderer: (params: any) => {
          ...
          return (
            <div className="d-flex gap-2 align-items-center h-100">
              <CButton
                onClick={() => navigate("/dmca-accusation/" + DMCAAccusationId + "/" + "episode")}
              >
                <Eye size={27} color='var(--secondary-green)' />
              </CButton>
            </div>
...
const DMCAAccusationView: FC<DMCAAccusationViewProps> = () => {
  ...
  const handleDataChange = async () => {
    setIsLoading(true);
    try {
      const response = await getDMCAList(adminAxiosInstance);
      if (response.success) {
          ...
          {isLoading ? (
            ...
            <div>
              <div className="flex justify-between items-center mb-4">
                <p className="pl-3 text-2xl font-bold text-black mb-0">Show</p>
                <Modal_Button
                  color="success"
                  className="dmca-view__add-btn"
                  size="lg"
                  title=''
                  content={
                    <>
                      <Plus size={20} weight="bold" className="me-2" />
                      Create Show DMCA Accusation
                    </>
                  }
                >
                  <DmcaModal type="show" onClose={() => { }} />
                </Modal_Button>
              </div>
              <div
              ...
              <div className="flex justify-between items-center mb-4 mt-5">
                <p className="pl-3 text-2xl font-bold text-black mb-0">Episode</p>
                <Modal_Button
                  color="success"
                  className="dmca-view__add-btn"
                  size="lg"
                  title="Create Episode DMCA Accusation"
                  content={
                    <>
                      <Plus size={20} weight="bold" className="me-2" />
                      Create Episode DMCA Accusation
                    </>
                  }
                >
                  <DmcaModal type="episode" onClose={() => { }} />
                </Modal_Button>
              </div>
              <div
                id="DMCAAccusation-table"
