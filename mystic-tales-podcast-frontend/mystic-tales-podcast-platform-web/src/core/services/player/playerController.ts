...
// // export type ListenSessionEpisodes = ListenSessionEpisodes;
// // export type ListenSessionBookingTracks = Liany;
// // export type ListenSessionProcedure = any;
...
//     this.audio.addEventListener("seeking", () => this.emitState());
//     this.audio.addEventListener("seeked", () => this.emitState());
...
//     // Add listeners to arrays instead of replacing
...
//     // Return cleanup function to remove these specific listeners
//     return () => {
//       if (events.onStateChange) {
...
//   /** Dùng khi bạn đã có newSession sau /navigate Next/Prev */
...
//     isSeekThenPlay?: boolean;
//   }) {
//     // thực chất giống playFromExistingSession, có thể gọi lại hàm trên
