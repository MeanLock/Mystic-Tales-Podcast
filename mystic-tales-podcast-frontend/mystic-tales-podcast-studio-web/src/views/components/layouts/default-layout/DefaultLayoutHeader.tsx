...
import { AppBar, Toolbar, Box, IconButton, Button, InputBase, Avatar, Menu as MuiMenu, MenuItem, ListItemIcon, ListItemText, Typography, Divider } from "@mui/material";
    ...
    <AppBar position="fixed" className="default-layout__header">
      <Toolbar className="default-layout__header-content">
        ...
        <Box className="default-layout__header-brand gap-3">
          ...
          <img src={logo || "/placeholder.svg"} alt="Logo" className="default-layout__header-brand-logo" />
