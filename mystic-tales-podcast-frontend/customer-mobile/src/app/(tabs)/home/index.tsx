  ...
  return (
    ...
    >
      ...
      <ShowCarousel
        variant="normal"
        title={
          <MixxingText originalText="Trending Shows" coloredText="Trending" />
        }
        shows={data1}
      />
      ...
      <ShowCarousel
        ...
        title={
          <MixxingText
            originalText="Most Listened Shows"
            coloredText="Most Listened"
          />
        }
        shows={data2}
      />
      ...
      <EpisodeCarousel
        title={
          <MixxingText
            originalText="Top Single Episodes"
            coloredText="Single Episodes"
          />
        }
        episodes={data3}
      />
      ...
      <ShowCarousel
        variant="normal"
        title={
          <MixxingText originalText="Folk Horror Story" coloredText="\\?\\" />
        }
        shows={data2}
      />
      ...
      <ShowCarousel
        variant="normal"
        title={
          <MixxingText originalText="Cultivation Novel" coloredText="\\?\\" />
        }
        shows={data2}
      />
      ...
      <ShowCarousel
        variant="normal"
        title={<MixxingText originalText="True Crime" coloredText="\\?\\" />}
        shows={data2}
      />
      ...
      <ShowCarousel
        variant="normal"
        title={
          <MixxingText originalText="Urband Legends" coloredText="\\?\\" />
        }
        shows={data2}
      />
